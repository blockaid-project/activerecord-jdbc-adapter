# -*- encoding: utf-8 -*-
# stub: activerecord-jdbch2-adapter 52.7 java lib
...
Gem::Specification.new do |s|
  ...
  s.files = ["History.txt".freeze, "LICENSE.txt".freeze, "README.txt".freeze, "Rakefile".freeze, "activerecord-jdbch2-adapter.gemspec".freeze, "lib/active_record/connection_adapters/jdbch2_adapter.rb".freeze, "lib/activerecord-jdbch2-adapter.rb".freeze]
